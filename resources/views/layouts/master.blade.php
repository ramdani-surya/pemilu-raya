        ...
        <div class="deznav">
            <div class="deznav-scroll mm-active">
				<ul class="metismenu mm-show" id="menu">
                    <li class="{{ request()->routeIs('dashboard.index') ? 'mm-active' : '' }}"><a class="ai-icon" href="{{ route('admin.dashboard') }}" aria-expanded="false">
                    ...
                    <li class="{{ request()->routeIs('candidates.index') ? 'mm-active' : '' }}"><a class="ai-icon" href="{{ route('candidates.index') }}" aria-expanded="false">
