                ...
                <div class="col-sm-6">
                    <div class="card avtivity-card">
                        <div class="card-body">
                            ...
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-secondary" style="height:5px;" id="bpmSudahMemilihBar"
                                    role="progressbar">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="card avtivity-card">
                        <div class="card-body">
                            ...
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-danger" style="height:5px;" id="bpmBelumMemilihBar"
                                    role="progressbar">
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-xl-6 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.dashboard.show', 'bpm') }}" class="btn btn-sm btn-faculty">Filter
                        Fakultas</a>
                </div>
                <div class="card-body">
                ...
                <div class="col-sm-6">
                    <div class="card avtivity-card">
                        <div class="card-body">
                            ...
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-secondary" style="height:5px;" id="bemSudahMemilihBar"
                                    role="progressbar">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="card avtivity-card">
                        <div class="card-body">
                            ...
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-danger" style="height:5px;" id="bemBelumMemilihBar"
                                    role="progressbar">
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-xl-6 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.dashboard.show', 'bem') }}" class="btn btn-sm btn-faculty">Filter
                        Fakultas</a>
                </div>
                <div class="card-body">
